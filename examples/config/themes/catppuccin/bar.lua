...
function M.apply(tokens)
    ...
    wyrd.style("chip_accent", {
        background = "linear-gradient(135deg, rgba(203, 166, 247, 0.22) 0%, rgba(180, 190, 254, 0.16) 100%)",
        foreground = colors.primary,
        accent     = colors.primary,
        outline    = "1px solid " .. colors.border_glow,
        radius     = 9999,
        ...
        hover      = {
            background = "linear-gradient(135deg, rgba(203, 166, 247, 0.32) 0%, rgba(180, 190, 254, 0.25) 100%)",
            foreground = "#FFFFFF",
            outline    = "1px solid " .. colors.primary,
        },
    })
    ...
    wyrd.style("launcher_round", {
        background = "linear-gradient(135deg, rgba(203, 166, 247, 0.24) 0%, rgba(180, 190, 254, 0.16) 100%)",
        foreground = colors.primary,
        outline    = "1px solid " .. colors.border_glow,
        radius     = 9999,
        font       = font,
        ...
        hover      = {
            background = "linear-gradient(135deg, rgba(203, 166, 247, 0.36) 0%, rgba(180, 190, 254, 0.26) 100%)",
            foreground = "#FFFFFF",
            outline    = "1px solid " .. colors.primary,
    ...
    wyrd.style("power_round", {
        ...
        outline    = "1px solid rgba(243, 139, 168, 0.15)",
        radius     = 9999,
        font       = font,
        font_size  = 12,
        hover      = {
