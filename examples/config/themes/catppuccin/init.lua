-- =============================================================================
-- CATPPUCCIN MOCHA DESIGN SYSTEM: THEME INITIALIZATION
-- =============================================================================

local M = {}

M.tokens = require("themes.catppuccin.tokens")
M.bar = require("themes.catppuccin.bar")
M.popups = require("themes.catppuccin.popups")
