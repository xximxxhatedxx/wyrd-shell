-- =============================================================================
-- AETHERIA DESIGN SYSTEM: POPUP STYLES
-- =============================================================================
...
function M.apply(tokens)
    ...
    wyrd.style("row_btn_active", {
        background = "linear-gradient(135deg, rgba(125, 211, 252, 0.18) 0%, rgba(196, 181, 253, 0.12) 100%)",
        foreground = colors.primary,
        outline    = "1px solid " .. colors.border_glow,
        radius     = 10,
        padding    = { horizontal = 12, vertical = 8 },
    ...
    wyrd.style("audio_sink_active", {
        ...
        padding    = { horizontal = 10, vertical = 6 },
        font_weight = "bold",
        hover      = { background = "linear-gradient(135deg, rgba(125, 211, 252, 0.28) 0%, rgba(196, 181, 253, 0.20) 100%)", foreground = colors.primary },
    })
    ...
    -- ============================================================
    -- 10. SYSTEM TRAY CONTEXT MENU STYLES (AETHERIA COSMIC ACRYLIC)
    -- ============================================================
