-- =============================================================================
-- TOKYO NIGHT DESIGN SYSTEM: POPUP STYLES
-- =============================================================================
...
function M.apply(tokens)
    ...
    wyrd.style("row_btn_active", {
        background = "linear-gradient(135deg, rgba(122, 162, 247, 0.20) 0%, rgba(187, 154, 247, 0.14) 100%)",
        foreground = colors.primary,
        outline    = "1px solid " .. colors.border_glow,
        radius     = 10,
        padding    = { horizontal = 12, vertical = 8 },
    ...
    wyrd.style("audio_sink_active", {
        ...
        padding    = { horizontal = 10, vertical = 6 },
        font_weight = "bold",
        hover      = { background = "linear-gradient(135deg, rgba(122, 162, 247, 0.30) 0%, rgba(187, 154, 247, 0.22) 100%)", foreground = colors.primary },
    })
